    ...
    <main>
      <div className="relative h-[96vh] bg-[#111111] grid justify-center items-center overflow-hidden">
        ...
        <div className="grid gap-3 z-50">
          ...
          <h1 className="phone:text-base lg:text-xl bg-clip-text text-transparent bg-gradient-to-b from-neutral-200 via-stone-400 to-neutral-500 text-center tracking-tighter font-medium py-1 opacity-80">
            Enginner at somewhere...
          </h1>
