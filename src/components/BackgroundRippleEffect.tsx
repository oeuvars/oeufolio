    ...
    <div className="relative h-screen bg-[#111111] grid justify-center items-center overflow-hidden">
      ...
      <div className="grid gap-3 z-50">
        <motion.div
          ...
          initial="hidden"
          animate="enter"
          className="relative pointer-events-none select-none flex gap-2 justify-center"
        >
        ...
        <motion.div
          ...
          initial="hidden"
          animate="enter"
          className="phone:text-2xl lg:text-3xl font-playfair bg-clip-text text-transparent bg-gradient-to-b from-neutral-200 via-stone-300 to-neutral-400 tracking-tight text-center"
        >
          Lemme land G.
        </motion.div>
        <motion.div
          className="flex justify-between phone:gap-2 lg:gap-0 mt-2 w-full"
