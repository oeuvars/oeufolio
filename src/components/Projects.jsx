...
const Projects = () => {
  return (
    <section id="designs" className="pt-48 lg:pt-20 md:pt-20">
      ...
      {/* PROJECTS */}
      <motion.div className="grid md:grid-cols-4 sm:grid-cols-2 gap-14 sm:gap-12 pt-16 pb-12 lg:flex-row lg:flex-wrap">
            <motion.div className="scale-100 ease-in hover:scale-110 hover:opacity-90 transition duration-500 basis-1/3 flex-1">
              <img src={day1} alt="" className="rounded-lg object-cover drop-shadow-2xl" width={'100%'} height={'100%'} responsive/>
            </motion.div>
            <motion.div className="scale-100 ease-in hover:scale-110 hover:opacity-90 transition duration-500 basis-1/3 flex-1">
