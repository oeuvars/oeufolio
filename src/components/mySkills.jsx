      ...
      <div className="md:flex md:justify-between mt-16 gap-32">
        ...
        >
          <div className="relative h-32">
            ...
            <div className="w-1/2 md:w-3/4 h-32 bg-gradient-to-r from-yellow-200 via-pink-200 to-pink-400 saturate-150 rounded-lg opacity-30 drop-shadow-2xl absolute right-0 top-0 z-[-1]" />
          </div>
        ...
        >
          <div className="relative h-32">
            ...
            <div className="w-1/2 md:w-3/4 h-32 bg-gradient-to-r from-red-200 via-red-300 to-yellow-200 saturate-200 rounded-lg opacity-30 drop-shadow-2xl absolute right-0 top-0 z-[-1]" />
          </div>
          <p className="mt-5 font-outfit font-medium text-base text-jet">
        ...
        >
          <div className="relative h-32">
            ...
            <div className="w-1/2 md:w-3/4 h-32 bg-gradient-to-r from-yellow-200 via-green-200 to-green-300 saturate-150 rounded-lg opacity-40 drop-shadow-2xl absolute right-0 top-0 z-[-1]" />
          </div>
          <p className="mt-5 font-outfit font-medium text-base text-jet">
