...
export const H1 = createComponent<HTMLHeadingElement>(
  'h1',
  'scroll-m-20 phone:text-5xl lg:text-7xl p-2 font-medium tracking-tight',
  'H1'
);
...
export const P = createComponent<HTMLParagraphElement>(
  'p',
  'leading-0 font-medium text-sm tracking-tight',
  'P'
);
...
export const Small = createComponent<HTMLParagraphElement>(
  'p',
  'phone:text-sm lg:text-xl tracking-tighter font-medium leading-none',
  'Small'
);
